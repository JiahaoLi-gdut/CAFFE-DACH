#ifndef CAFFE_HOMO_MEAN_LOSS_LAYER_HPP_
#define CAFFE_HOMO_MEAN_LOSS_LAYER_HPP_
...
class HomoMeanLossLayer : public Layer<Dtype> {
public:
  explicit HomoMeanLossLayer(const LayerParameter& param)
      : Layer<Dtype>(param),
  ...
  virtual inline const char* type() const { return "HomoMeanLoss"; }
...
protected:
  ...
  virtual void ClusterTesting_cpu(const vector<Blob<Dtype>*>& bottom);
  virtual void ClusterTesting_gpu(const vector<Blob<Dtype>*>& bottom);
  ...
  virtual void ClusupdTesting_cpu(const vector<Blob<Dtype>*>& bottom);
  virtual void ClusupdTesting_gpu(const vector<Blob<Dtype>*>& bottom);
  ...
  virtual void OdotterTesting_cpu(const vector<Blob<Dtype>*>& bottom);
  virtual void OdotterTesting_gpu(const vector<Blob<Dtype>*>& bottom);
  ...
  virtual void PredictTesting_cpu(const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top);
  virtual void PredictTesting_gpu(const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top);
  ...
  HomoMeanLossParameter_NormalizationMode cluster_normalization_;
  HomoMeanLossParameter_NormalizationMode scatter_normalization_;
  HomoMeanLossParameter_NormalizationMode ovalize_normalization_;
  bool average_initmode_;
  int match_numb_;
  int label_nmax_;
  int label_axis_;
  int target_label_;
...
#endif // CAFFE_HOMO_MEAN_LOSS_LAYER_HPP_