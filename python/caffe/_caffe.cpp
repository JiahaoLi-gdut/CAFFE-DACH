...
void Net_before_preforward(Net<Dtype>* net, bp::object run) {
  net->add_before_preforward(new NetCallback<Dtype>(run));
}
void Net_after_preforward(Net<Dtype>* net, bp::object run) {
  net->add_after_preforward(new NetCallback<Dtype>(run));
}
void Net_before_prebackward(Net<Dtype>* net, bp::object run) {
  net->add_before_prebackward(new NetCallback<Dtype>(run));
}
void Net_after_prebackward(Net<Dtype>* net, bp::object run) {
  net->add_after_prebackward(new NetCallback<Dtype>(run));
}
...
BOOST_PYTHON_MODULE(_caffe) {
  ...
  bp::class_<Net<Dtype>, shared_ptr<Net<Dtype> >, boost::noncopyable >("Net",
    ...
    .def("before_preforward", &Net_before_preforward)
    .def("after_preforward", &Net_after_preforward)
    .def("before_prebackward", &Net_before_prebackward)
    .def("after_prebackward", &Net_after_prebackward);
