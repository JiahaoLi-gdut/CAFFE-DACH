...
class TestNet(unittest.TestCase):
    ...
    def test_forward_backward(self, preforward_flag, prebackward_flag):
        self.net.forward(preforward_flag)
        self.net.backward(prebackward_flag)

    def test_forward_start_end(self, preforward_flag):
        ...
        forward_blob=self.net.forward(preforward_flag, start='ip',end='ip')
    ...
    def test_backward_start_end(self, prebackward_flag):
        conv_blob=self.net.blobs['conv']
        ip_blob=self.net.blobs['ip_blob']
        sample_data=np.random.uniform(size=ip_blob.data.shape)
        sample_data=sample_data.astype(np.float32)
        ip_blob.diff[:]=sample_data
        backward_blob=self.net.backward(prebackward_flag, start='ip',end='ip')
    ...
    def test_clear_param_diffs(self, preforward_flag, prebackward_flag):
