...
TYPED_TEST(ConvolutionLayerTest, TestSobelConvolution) {
  ...
  layer->Forward(sep_blob_bottom_vec, sep_blob_top_vec, false);
...
TYPED_TEST(ConvolutionLayerTest, TestNDAgainst2D) {
  ...
  // Test with 2D im2col
  {
    ...
    layer_2d.Forward(this->blob_bottom_vec_, this->blob_top_vec_, false);
    copy_diff = false; reshape = true;
  ...
  // Test with ND im2col
  {
    ...
    layer_nd.Forward(this->blob_bottom_vec_, this->blob_top_vec_, false);
    copy_diff = false; reshape = true;
