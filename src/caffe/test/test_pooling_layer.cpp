...
class PoolingLayerTest : public MultiDeviceTest<TypeParam> {
 ...
 protected:
  ...
  void TestForwardSquare() {
    ...
    layer.Forward(blob_bottom_vec_, blob_top_vec_, false);
    ...
    if (blob_top_vec_.size() > 1) {
      ...
      //     [5 12 12 9]
      for (int i = 0; i < 8 * num * channels; i += 8) {
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 0],  5 + (i / 8 % channels) * 15);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 1],  2 + (i / 8 % channels) * 15);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 2],  2 + (i / 8 % channels) * 15);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 3],  9 + (i / 8 % channels) * 15);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 4],  5 + (i / 8 % channels) * 15);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 5], 12 + (i / 8 % channels) * 15);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 6], 12 + (i / 8 % channels) * 15);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 7],  9 + (i / 8 % channels) * 15);
      }
    }
  }
  ...
  void TestForwardRectHigh() {
    ...
    if (blob_top_vec_.size() > 1) {
        ...
        // [32    32    27    35    35]
      for (int i = 0; i < 20 * num * channels; i += 20) {
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  0],  0 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  1],  7 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  2],  3 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  3], 16 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  4], 16 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  5],  7 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  6], 20 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  7], 20 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  8], 16 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  9], 16 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 10], 12 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 11], 26 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 12], 26 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 13], 16 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 14], 16 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 15], 31 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 16], 31 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 17], 26 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 18], 34 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 19], 34 + (i / 20 % channels) * 36);
      }
    }
  }
  ...
  void TestForwardRectWide() {
    ...
    if (blob_top_vec_.size() > 1) {
      ...
      for (int i = 0; i < 20 * num * channels; i += 20) {
        ...
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  1],  7 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  2],  3 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  3],  3 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  4],  7 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  5],  7 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  6], 16 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  7], 16 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  8], 20 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i +  9], 20 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 10], 20 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 11], 16 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 12], 26 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 13], 26 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 14], 26 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 15], 21 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 16], 31 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 17], 31 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 18], 26 + (i / 20 % channels) * 36);
        EXPECT_EQ(blob_top_mask_->cpu_data()[i + 19], 34 + (i / 20 % channels) * 36);
      }
    }
  }
...
TYPED_TEST(PoolingLayerTest, TestSetupGlobalPooling) {
  ...
  LayerParameter layer_param;
  PoolingParameter* pooling_param = layer_param.mutable_pooling_param();
  pooling_param->set_global_pooling3d(true);
  pooling_param->set_pool(PoolingParameter_PoolMethod_AVE);
  PoolingLayer<Dtype> layer(layer_param);
  layer.SetUp(this->blob_bottom_vec_, this->blob_top_vec_);
  EXPECT_EQ(this->blob_top_->num(), this->blob_bottom_->num());
...
TYPED_TEST(PoolingLayerTest, PrintBackward) {
  ...
  layer.SetUp(this->blob_bottom_vec_, this->blob_top_vec_);
  layer.Forward(this->blob_bottom_vec_, this->blob_top_vec_, false);
  ...
  layer.Backward(this->blob_top_vec_, true, this->blob_bottom_vec_, false);
  for (int i = 0; i < this->blob_bottom_->count(); ++i) {
...
TYPED_TEST(PoolingLayerTest, TestForwardMaxPadded) {
  ...
  pooling_param->set_stride_w(2);
  pooling_param->set_pad_c(0);
  pooling_param->set_pad_h(2);
  pooling_param->set_pad_w(2);
  pooling_param->set_pool(PoolingParameter_PoolMethod_MAX);
...
TYPED_TEST(PoolingLayerTest, TestForwardAve) {
  ...
  layer.Forward(this->blob_bottom_vec_, this->blob_top_vec_, false);
  Dtype epsilon = 1e-5;
  EXPECT_NEAR(this->blob_top_->cpu_data()[0],  8.0 / 4, epsilon);
  EXPECT_NEAR(this->blob_top_->cpu_data()[1], 12.0 / 6, epsilon);
  EXPECT_NEAR(this->blob_top_->cpu_data()[2],  8.0 / 4, epsilon);
  EXPECT_NEAR(this->blob_top_->cpu_data()[3], 12.0 / 6, epsilon);
  EXPECT_NEAR(this->blob_top_->cpu_data()[4], 18.0 / 9   , epsilon);
  EXPECT_NEAR(this->blob_top_->cpu_data()[5], 12.0 / 6, epsilon);
  EXPECT_NEAR(this->blob_top_->cpu_data()[6],  8.0 / 4, epsilon);
  EXPECT_NEAR(this->blob_top_->cpu_data()[7], 12.0 / 6, epsilon);
  EXPECT_NEAR(this->blob_top_->cpu_data()[8],  8.0 / 4, epsilon);
}
