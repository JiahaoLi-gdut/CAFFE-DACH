  ...
  if (v0_layer_connection.has_layer()) {
    ...
    if (v0_layer_param.has_pad()) {
      if (type == "conv") {
        ...
        layer_param->mutable_pooling_param()->set_pad_c(0);
        layer_param->mutable_pooling_param()->set_pad_h(v0_layer_param.pad());
        layer_param->mutable_pooling_param()->set_pad_w(v0_layer_param.pad());
      } else {
    ...
    if (v0_layer_param.has_kernelsize()) {
      if (type == "conv") {
        ...
        layer_param->mutable_pooling_param()->set_kernel_c(
            1);
        layer_param->mutable_pooling_param()->set_kernel_h(
            v0_layer_param.kernelsize());
        layer_param->mutable_pooling_param()->set_kernel_w(
            v0_layer_param.kernelsize());
      } else {
    ...
    if (v0_layer_param.has_stride()) {
      if (type == "conv") {
        ...
        layer_param->mutable_pooling_param()->set_stride_c(
            1);
        layer_param->mutable_pooling_param()->set_stride_h(
            v0_layer_param.stride());
        layer_param->mutable_pooling_param()->set_stride_w(
            v0_layer_param.stride());
      } else {
